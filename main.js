...
var Card = /*#__PURE__*/function () {
  ...
  return _createClass(Card, [{
    ...
    value: function onRemoveBtnClick() {
...
var Form = /*#__PURE__*/function () {
  ...
  return Form_createClass(Form, [{
    ...
    value: function closeForm() {
      this.textarea.value = '';
      this.hideForm();
      var btn = this.element.nextElementSibling;
    ...
    value: function onSubmitForm(event) {
      ...
      var flag = cardList.some(function (card) {
...
;// CONCATENATED MODULE: ./src/components/column/Column.js
...
function DragController_typeof(o) { "@babel/helpers - typeof"; return DragController_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, DragController_typeof(o); }
function DragController_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function DragController_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, DragController_toPropertyKey(o.key), o); } }
function DragController_createClass(e, r, t) { return r && DragController_defineProperties(e.prototype, r), t && DragController_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function DragController_toPropertyKey(t) { var i = DragController_toPrimitive(t, "string"); return "symbol" == DragController_typeof(i) ? i : i + ""; }
function DragController_toPrimitive(t, r) { if ("object" != DragController_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != DragController_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var DragController = /*#__PURE__*/function () {
  function DragController() {
    DragController_classCallCheck(this, DragController);
  ...
  return DragController_createClass(DragController, [{
    key: "cloneCard",
  ...
  return Storage_createClass(Storage, [{
    ...
    value: function getStorage() {
      if (!localStorage.getItem('formdata')) {
        // если сами не создавали ничего, то возьмём из заготовки
        this.formData = structuredClone(js_allCards); // глубокая копия заготовки
      } else {
